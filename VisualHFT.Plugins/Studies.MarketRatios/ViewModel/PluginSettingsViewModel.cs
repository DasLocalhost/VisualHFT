...
namespace VisualHFT.Studies.MarketRatios.ViewModel
{
    ...
    {
        private const string _defaultHeader = "Market Ratios PlugIn Settings";
        ...
        public PluginSettingsViewModel(PlugInSettings settings) : base(settings, _defaultHeader)
        {
            ...
            // Default value should be defined by method generating the default instance of the settings
