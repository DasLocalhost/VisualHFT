...
{
    public class SlackSettingsViewModel : BaseNotificationSettingsViewModel
    {
        private const string _defaultHeader = "Slack Notifications Settings";
        ...
        public SlackSettingsViewModel(SlackNotificationSetting setting) : base(setting, _defaultHeader)
        {
        ...
        public override void ApplyChanges()
        {
            ...
            if (!(_setting is SlackNotificationSetting castedSetting))
                return;
